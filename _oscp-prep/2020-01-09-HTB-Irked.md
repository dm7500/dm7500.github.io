...
- [Initial Shell](#initial-shell)
  - [Testing for Unreal IRC backdoor with Nmap](#testing-for-unreal-irc-backdoor-with-nmap)
  - [Use Nmap NSE script to get reverse shell](#use-nmap-nse-script-to-get-reverse-shell)
- [Privlege Escalation](#privlege-escalation)
  - [Poking around](#poking-around)
  - [Steghide](#steghide)
  - [SSH as user and grab flag](#ssh-as-user-and-grab-flag)
  - [Enumerate for escalation](#enumerate-for-escalation)
  - [Make the listusers file and root shell](#make-the-listusers-file-and-root-shell)
